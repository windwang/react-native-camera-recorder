...
import com.wind.camera.model.BaseMediaBitrateConfig;
import com.wind.camera.model.MediaObject;
import com.wind.camera.model.MediaObject.MediaPart;
import com.wind.camera.util.DeviceUtils;
import com.wind.camera.util.FileUtils;
import com.wind.camera.util.StringUtils;
...
public abstract class MediaRecorderBase implements Callback, PreviewCallback, IMediaRecorder {
    ...
    public static BaseMediaBitrateConfig mediaRecorderConfig;
