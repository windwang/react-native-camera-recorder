...
public final class MediaRecorderConfig implements Parcelable {
    ...
    private MediaRecorderConfig(Builder builder) {
        this.RECORD_TIME_MAX = builder.RECORD_TIME_MAX;
        this.RECORD_TIME_MIN = builder.RECORD_TIME_MIN;
        this.MAX_FRAME_RATE = builder.MAX_FRAME_RATE;
        this.captureThumbnailsTime = builder.captureThumbnailsTime;
        this.MIN_FRAME_RATE = builder.MIN_FRAME_RATE;
        this.SMALL_VIDEO_HEIGHT = builder.SMALL_VIDEO_HEIGHT;
        this.SMALL_VIDEO_WIDTH = builder.SMALL_VIDEO_WIDTH;
        this.VIDEO_BITRATE = builder.VIDEO_BITRATE;
        this.doH264Compress = builder.doH264Compress;
        this.mediaBitrateConfig= builder.mediaBitrateConfig;
    ...
    public static class Builder {
         ...
         */
        @Deprecated
        public Builder doH264Compress(boolean doH264Compress) {
         ...
         * @return
         */
        public Builder setMediaBitrateConfig(BaseMediaBitrateConfig mediaBitrateConfig) {
