...
//        }
  ...
  public void onEncodeComplete() {
    if (this.promise != null) {
      ...
      File f = new File(mMediaObject.getOutputVideoThumbPath());
      map.putString("thumb", Uri.fromFile(f).toString());
      f = new File(mMediaObject.getOutputTempTranscodingVideoPath());
      map.putString("path", Uri.fromFile(f).toString());
