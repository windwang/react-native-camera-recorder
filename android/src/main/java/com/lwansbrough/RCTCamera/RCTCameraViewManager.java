...
public class RCTCameraViewManager extends ViewGroupManager<RCTCameraView> {
    ...
    public void capture(RCTCameraView view, final ReadableMap options, final Promise promise) {
...
//        }
    ...
    public void stopCapture(RCTCameraView view, final Promise promise) {
        view.stopCapture(promise);
    }
